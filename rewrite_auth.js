...
export function Logo({ className = "w-8 h-8" }: { className?: string }) {
  return (
    <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M48 10 C 65 10, 80 20, 88 38 L 72 44 C 68 32, 58 26, 48 26 Z" fill="currentColor" />
      <path d="M90 48 C 90 65, 80 80, 62 88 L 56 72 C 68 68, 74 58, 74 48 Z" fill="currentColor" />
      <path d="M52 90 C 35 90, 20 80, 12 62 L 28 56 C 32 68, 42 74, 52 74 Z" fill="currentColor" />
      <path d="M10 52 C 10 35, 20 20, 38 12 L 44 28 C 32 32, 26 42, 26 52 Z" fill="currentColor" />
    </svg>
  );
}
`;
    ...
    <div className="min-h-screen bg-[#0B1120] flex flex-col items-center justify-center p-4 font-sans text-slate-200">
      ...
      <div className="mb-8 flex flex-col items-center">
        <div className="flex items-center gap-3 mb-3">
          ...
          <span className="text-3xl font-bold tracking-wide text-white" style={{ fontFamily: 'sans-serif' }}>KNOXIFIED</span>
        </div>
        <p className="text-[#5CE1E6] text-[11px] tracking-widest uppercase font-semibold">"Think. Automate. Elevate"</p>
      </div>

      <div className="w-full max-w-md bg-[#162032] p-8 rounded-2xl border border-white/5 shadow-2xl relative overflow-hidden">
  ...
  return (
    <div className="min-h-screen bg-[#0B1120] flex flex-col items-center justify-center p-4 font-sans text-slate-200">
      ...
      <div className="mb-8 flex flex-col items-center">
        <div className="flex items-center gap-3 mb-3">
          <Logo className="w-10 h-10 text-[#5CE1E6]" />
          <span className="text-3xl font-bold tracking-wide text-white">KNOXIFIED</span>
        </div>
        <p className="text-[#5CE1E6] text-[11px] tracking-widest uppercase font-semibold">"Think. Automate. Elevate"</p>
      </div>
      ...
      <div className="w-full max-w-md bg-[#162032] p-8 rounded-2xl border border-white/5 shadow-2xl relative overflow-hidden">
        ...
        <Link href="/login" className="inline-flex items-center text-sm font-medium text-slate-400 hover:text-white transition-colors mb-6">
...
fs.writeFileSync('components/Logo.tsx', logoTsx);

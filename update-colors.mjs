...
const rootFiles = walk('./components');
const libFiles = walk('./lib');

const allFiles = [...files, ...rootFiles, ...libFiles, './tailwind.config.ts', './postcss.config.mjs'].filter(f => fs.existsSync(f));

const replacements = [
  { from: /#0B0D10/g, to: '#020617' }, // Deep Navy Background
  { from: /#161B22/g, to: '#0F172A' }, // Slate 900 Cards
  { from: /#4F8CFF/g, to: '#00E5FF' }, // Neon Cyan Accent
  { from: /bg-\[#4F8CFF\]/g, to: 'bg-[#00E5FF]' }, 
  { from: /text-\[#4F8CFF\]/g, to: 'text-[#00E5FF]' },
  { from: /border-\[#4F8CFF\]/g, to: 'border-[#00E5FF]' },
  { from: /#22C55E/g, to: '#10B981' } // Emerald green matches the video's green ticks beautifully
];
